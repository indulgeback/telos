  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          'relative has-focus:border-foreground/35 border border-input shadow-xs has-focus:ring-1 has-focus:ring-foreground/10 rounded-md',
